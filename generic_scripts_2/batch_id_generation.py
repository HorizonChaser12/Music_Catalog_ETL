...
def check_incomplete_batch_id(cursor, source_system: str, phase_name: str) -> Optional[str]:
    ...
    query = "SELECT * FROM AUDIT.BATCH_LOG WHERE source_system = %s AND phase_name = %s"
...
def generate_etl_batch_id(cursor, source_system: str, phase_name: str , table_names: list) -> str:
    """
...
def main():
    ...
    try:
        ...
        etl_batch_id = generate_etl_batch_id(cursor, source_name, phase_name , table_names)
        print(etl_batch_id)
