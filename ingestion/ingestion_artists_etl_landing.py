...
def fetch_artists(artists: List) :
    ...
    try:
        for artist in artists:
            ...
            fetched_data.append(artist_data)
...
def fetch_releases(artist_list:List[str]):
    ...
    os.makedirs("data/raw/releases", exist_ok=True)

    current_date = datetime.now().strftime("%Y_%m_%d")

    file_path = f"data/raw/releases/releases_{current_date}.json"
...
def main():
    # 1. Fetch Artists
    logger.info(f".......Artist Data API fetch started....... \n")
    ...
    logger.info(f".......Artist Data API fetch completed....... \n")
    
    if artist_data:
        logger.info(f"Release Data API fetch started....... \n")
        ...
        logger.info(f"Release Data API fetch completed....... \n")
